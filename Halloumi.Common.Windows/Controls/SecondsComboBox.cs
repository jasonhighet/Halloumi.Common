...
namespace Halloumi.Common.Windows.Controls
{
    public class SecondsComboBox : KryptonComboBox
    {
        ...
        public SecondsComboBox()
            : base()
        {
            this.SelectedIndexChanged += new EventHandler(SecondsComboBox_SelectedIndexChanged);
        }
        ...
        {
            this.Items.Clear();
            //foreach (double value in secondsList)
            //{
            //    this.Items.Add(GetFormattedSeconds(value));
            //}
        }
